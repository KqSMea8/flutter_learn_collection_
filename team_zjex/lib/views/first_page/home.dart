...
import 'package:team_zjex/views/first_page/first_page.dart';
// import 'package:team_zjex/views/widget_page/widget_page.dart';
// import 'package:team_zjex/views/welcome_page/fourth_page.dart';
// import 'package:team_zjex/views/collection_page/collection_page.dart';
import 'package:team_zjex/routers/application.dart';
import 'package:team_zjex/utils/provider.dart';
// import 'package:team_zjex/model/widget.dart';
// import 'package:team_zjex/widgets/index.dart';
// import 'package:team_zjex/components/search_input.dart';
import 'package:team_zjex/model/search_history.dart';
// import 'package:team_zjex/resources/widget_name_to_icon.dart';
...
class _MyHomePageState extends State<AppPage>
  ...
  static List tabData = [
    {'text': '任务管理', 'icon': new Icon(Icons.language)},
    {'text': '项目管理', 'icon': new Icon(Icons.extension)},
    {'text': '需求管理', 'icon': new Icon(Icons.favorite)},
    {'text': '企业管理', 'icon': new Icon(Icons.import_contacts)}
  ];
